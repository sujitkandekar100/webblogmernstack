        ...
        <>
            ...
            <div className="flex gap-6 justify-between">
                ...
                <div className="flex gap-6 items-center">
                    ...
                    <Link to={`https://www.linkedin.com/sharing/share-offsite/?text=Read ${title}&url=${location.href}`}>  <i className="fi fi-brands-linkedin text-xl hover:text-linkedin"></i></Link>
