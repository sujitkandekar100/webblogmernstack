...
const BlogInteraction = () => {
    ...
    useEffect(() => {
        if (access_token) {
            ...
            axios
                .post(import.meta.env.VITE_SERVER_DOMAIN + "/isliked-by-user", { _id }, {
                    headers: {
        ...
        <>
            ...
            <div className="flex gap-6 justify-between">
                ...
                <div className="flex gap-6 items-center">
                    ...
                    {/* Twitter Share Button with Banner Image */}
                    <a
                        href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(`Read ${title}`)}&url=${encodeURIComponent(window.location.href)}`}
                        target="_blank"
